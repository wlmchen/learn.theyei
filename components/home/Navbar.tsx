      ...
      <div className="max-w-7xl mx-auto w-full flex justify-between items-center md:space-x-10 py-3 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex md:items-center">
          <div className="flex items-center md:ml-12">
            <a href="https://theyei.org" target="_blank">
            ...
            <Link href="/login">
              <span className="text-lg font-medium cursor-pointer text-gray-500 hover:text-gray-900">
                Login
              </span>
            </Link>
            <Link href="/signup">
              <span className="text-lg font-medium cursor-pointer ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-white bg-yei-primary-main hover:bg-yei-primary-darker">
                Sign up
              </span>
            </Link>
          </div>
