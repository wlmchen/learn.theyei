            ...
            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-20 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Strengthen your conceptual grasp of economics concepts and
                    prepare for competitions like the EconBowl and National
                    Economics Challenges with our multiple-choice questions.
                    Includes original questions and past questions from our
                    EconBowl competitions.
                  </p>
                </div>
              </div>
            </div>
            <div className="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
              <div className="pl-4 lg:m-0 lg:relative lg:h-full">
                <img
          ...
          <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-20 lg:max-w-none lg:mx-0 lg:px-0">
            <div>
              ...
              <div className="mt-6">
                ...
                <p className="mt-4 text-lg text-gray-500">
                  Practice for free-response questions on the AP Econ exams and
                  the EconOlympiad with our free-response questions. Includes
                  original questions, past AP questions, and past EconOlympiad
                  problems. Grading rubrics and solutions also available.
                </p>
              </div>
            </div>
          </div>
