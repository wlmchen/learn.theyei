...
<ol className="alpha-list-mdx">
	<li>Logan’s Logging Company sells £2 million of lumber to a factory that produces popsicle sticks. The factory unloads the finished sticks to Paul’s Popsicles for £1.5 million. Paul then uses the sticks in his popsicles and generates a total of £4 million in sales. </li>
	<li>Jett resells an RTX 3090 she found lying in her basement. Don't ask me how it got there.</li>
	<li>Leah buys and sells 500 Apple stock for a £8000 profit.</li>
</ol>

<FRQ num={3} totalPoints={3}>
	<FRQCheck points={1}>
		£4 million. Only final sales count towards the GDP; intermediate goods do not count.
	</FRQCheck>
	<FRQCheck points={1}>
		0. Resales do not count to the GDP.
	</FRQCheck>
	<FRQCheck points={1}>
		0. Completely financial transactions, such as stocks, don't count to the GDP.
	</FRQCheck>
</FRQCheck>